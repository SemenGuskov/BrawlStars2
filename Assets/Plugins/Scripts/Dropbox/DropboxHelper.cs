...
namespace Plugins.Scripts.Dropbox
{
    public static class DropboxHelper
    {
        ...
        // TEST
        //private const string AppKey = "mg714jhb2wowth7";
        //private const string AppSecret = "869etie1goaxppr";

        // PROD
        private const string AppKey = "da6s52b2pha34il";
        private const string AppSecret = "t1qcvq18km2vbkd";
        ...
        //TEST
        //private const string AuthCode = "ZB6PMcdh7EgAAAAAAAAAHOzNWomD5OJUby8F9hhtYHM";

        // PROD
        private const string AuthCode = "d0gSh9s4ELcAAAAAAAADKwc_FuCZ1th5qptNeBlqAAs";
#endif

        // paste from GetRefreshToken() result, value of "refresh_token"
        //TEST
        //private const string RefreshToken = "s27kEo3zRHsAAAAAAAAAASyciiDhkONpRBl2nfUExc8mw4iCLOe9nnOt_vO5QNqJ";

        // PROD
        private const string RefreshToken = "9V0MuquUOesAAAAAAAAAAfWePF90vuUrR2p-9fUWs0GiGTTfkUPpRU7mZierTPA3";
